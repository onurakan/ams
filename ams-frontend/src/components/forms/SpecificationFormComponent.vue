  ...
  <div>
    ...
    <div v-else>
      ...
      <div>
          ...
          <div class="divTableBody">
            ...
            <div class="divTableRow">
              ...
              <div v-if="edit2" class="divTableCell">
                <input id="specificationStatus" v-model.number="specification.status" type="number" @blur="$emit('update'); updateSpecification(specification.id)" @keyup.enter="$emit('update')" v-focus>
              </div>
            ...
            <div class="divTableRow">
              ...
              <div v-if="edit3" class="divTableCell">
                <input id="specificationAttribute" v-model.number="specification.attribute" @blur="$emit('update'); updateSpecification(specification.id)" @keyup.enter="$emit('update')" v-focus>
              </div>
              <div v-else class="divTableCell">
            ...
            <div class="divTableRow">
              ...
              <div v-if="edit4" class="divTableCell">
                <input id="specificationAttributeDescription" v-if="edit4" v-model="specification.attributeDescription" @blur="$emit('update'); updateSpecification(specification.id)" @keyup.enter="$emit('update')" v-focus>
              </div>
              <div v-else class="divTableCell">
            ...
            <div class="divTableRow">
              ...
              <div v-if="edit5" class="divTableCell">
                <input id="dataType" v-if="edit5" v-model="specification.dataType" @blur="$emit('update'); updateSpecification(specification.id)" @keyup.enter="$emit('update')" v-focus>
              </div>
              <div v-else class="divTableCell">
            ...
            <div class="divTableRow">
              ...
              <div v-if="edit6" class="divTableCell">
                <input id="alphanumericValue" v-if="edit6" v-model="specification.alphanumericValue" @blur="$emit('update'); updateSpecification(specification.id)" @keyup.enter="$emit('update')" v-focus>
              </div>
              <div v-else class="divTableCell">
            ...
            <div class="divTableRow">
              ...
              <div v-if="edit7" class="divTableCell">
                <input id="alphanumericDescription" v-if="edit7" v-model="specification.alphanumericDescription" @blur="$emit('update'); updateSpecification(specification.id)" @keyup.enter="$emit('update')" v-focus>
              </div>
              <div v-else class="divTableCell">
            ...
            <div class="divTableRow">
              ...
              <div v-if="edit8" class="divTableCell">
                <input id="numericValue" v-if="edit8" v-model="specification.numericValue" @blur="$emit('update'); updateSpecification(specification.id)" @keyup.enter="$emit('update')" v-focus>
              </div>
              <div v-else class="divTableCell">
            ...
            <div class="divTableRow">
              ...
              <div v-if="edit9" class="divTableCell">
                <input id="numericDescription" v-if="edit9" v-model="specification.numericDescription" @blur="$emit('update'); updateSpecification(specification.id)" @keyup.enter="$emit('update')" v-focus>
              </div>
              <div v-else class="divTableCell">
            ...
            <div class="divTableRow">
              ...
              <div v-if="edit10" class="divTableCell">
                <input id="unitOfMeasure" v-if="edit10" v-model="specification.unitOfMeasure" @blur="$emit('update'); updateSpecification(specification.id)" @keyup.enter="$emit('update')" v-focus>
              </div>
              <div v-else class="divTableCell">
            ...
            <div class="divTableRow">
              ...
              <div v-if="edit11" class="divTableCell">
                <input id="tableValue" v-if="edit11" v-model="specification.tableValue" @blur="$emit('update'); updateSpecification(specification.id)" @keyup.enter="$emit('update')" v-focus>
              </div>
              <div v-else class="divTableCell">
        ...
        <button v-if="specification.id == null" v-on:click="createSpecification()" style="margin-left: -80px; margin-top: 10px;" >Create Specification</button>
      </div>
    </div>
  </div>
</template>
    ...
    methods: {
        ...
        createSpecification : function () {
          if (this.specification.attribute != null &&
            ...
            this.isError = false;
            axios.post(this.ams_backend_url + '/api/specification', this.specification)
                    .then(response => {
                                        // JSON responses are automatically parsed.
                                        console.log("SpecificationFormComponent->createSpecification response:" + JSON.stringify(response.data));
                                        this.isUpdating = false;
                                        this.specification.id = response.data.id;
                                        alert("specificationId=" + this.specification.id + " is created :)");
                                    })
                    .catch(e => {
                        this.isUpdating = false;
                        if (e.response.status) {
        ...
        updateSpecification : function (specificationId) {
          if (specificationId != null && specificationId != '') {
            ...
            this.isError = false;
            axios.put(this.ams_backend_url + '/api/specification/' + specificationId, this.specification, this.auth)
                    .then(response => {
                                        // JSON responses are automatically parsed.
